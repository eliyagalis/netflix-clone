  ...
  return (
    <div className={`${colors.background.darkGray} text-white w-full min-h-screen`}>
      ...
      <div className="relative z-50 w-8/10 max-w-350 mx-auto">
        <Typography className="font-bold" size={typography.large}>
          {strings.landing.carousel.headline}
        </Typography>

        <LandingCarouselFeature />

        <Typography className="font-medium" size={typography.medium}>
          {strings.landing.plans.headline}
        </Typography>
        ...
        <Typography className="font-bold" size={typography.large}>
          {strings.landing.reasons.headline}
        </Typography>
        ...
        <Typography className="my-3 font-bold" size={typography.large}>
          {strings.landing.faq.headline}
        </Typography>
        <>
