...
const PaymentMethodButton:React.FC<LogoCard> = ({text,imagesChildren}) => {
  return (
    <Button color={colors.buttons.secondary} border='border-gray-300' className='p-4 max-w-[40rem] h-[5rem] my-10 w-full font-light' fontSize={typography.medium}>
