...
const Tv = () => {
    ...
    <defs>
      ...
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(26.8 26.8488) rotate(74.0546) scale(51.6507 39.1225)"
      >
        <stop stopColor="#1C0E20" stopOpacity="0.01"></stop>
        <stop offset="1" stopColor="#1C0E20"></stop>
      </radialGradient>
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(36.7034 46.2872) rotate(123.417) scale(10.7723)"
      >
        <stop stopColor="#F02A63"></stop>
        <stop offset="0.326996" stopColor="#E80F42"></stop>
        <stop offset="0.739049" stopColor="#D0093D"></stop>
        <stop offset="1" stopColor="#FF2F5C"></stop>
      </radialGradient>
    </defs>
  </svg>
      </div>
