...
const Add = ({ onClick }: { onClick: () => void }) => {
  return (
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M19.2 19.2L19.2 12H20.8L20.8 19.2L28 19.2V20.8L20.8 20.8L20.8 28H19.2L19.2 20.8L12 20.8V19.2L19.2 19.2Z" fill="white"/>
    </svg></div>
  )
}
